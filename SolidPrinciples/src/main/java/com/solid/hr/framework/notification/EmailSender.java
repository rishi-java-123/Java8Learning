...
public class EmailSender implements EmployeeNotifier {
    ...
    void notify ( Employee employee ) {
        ...
        prop.put("mail.smtp.ssl.trust", "smtp.google.io");
        ...
        try {
            ...
            // to/from
            message.setFrom(new InternetAddress("rishiranjan706@gmail.com"));
   ...
   /* public static void notify( Employee employee){
        ...
        prop.put("mail.smtp.auth", true);
        prop.put("mail.smtp.starttls.enable", "true");
        prop.put("mail.smtp.host", "smtp.google.io");
        ...
        try {
            ...
            // to/from
            message.setFrom(new InternetAddress("payment@saama.com"));
            message.setRecipients(
                    Message.RecipientType.TO,
                    InternetAddress.parse(employee.getEmail()));
